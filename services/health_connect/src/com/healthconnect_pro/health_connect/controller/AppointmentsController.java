...
import com.healthconnect_pro.health_connect.service.AppointmentsService;
 ...
 * @see Appointments
 */
@RestController("health_connect.AppointmentsController")
@Api(value = "AppointmentsController", description = "Exposes APIs to work with Appointments resource.")
@RequestMapping("/health_connect/Appointments")
public class AppointmentsController {
	...
	@ApiOperation(value = "Returns the total count of Appointments instances matching the optional query (q) request param.")
