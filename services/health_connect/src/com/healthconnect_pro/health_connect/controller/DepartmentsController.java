...
import com.healthconnect_pro.health_connect.service.DepartmentsService;
 ...
 * @see Departments
 */
@RestController("health_connect.DepartmentsController")
@Api(value = "DepartmentsController", description = "Exposes APIs to work with Departments resource.")
@RequestMapping("/health_connect/Departments")
public class DepartmentsController {
    ...
    @PutMapping(value = "/{id:.+}")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Departments editDepartments(@PathVariable("id") Integer id, @RequestBody Departments departments) {
        LOGGER.debug("Editing Departments with id: {}" , departments.getId());
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Departments patchDepartments(@PathVariable("id") Integer id, @RequestBody @MapTo(Departments.class) Map<String, Object> departmentsPatch) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteDepartments(@PathVariable("id") Integer id) {
    ...
    @GetMapping(value = "/departmentName-departmentHead-departmentDescription" )
    @ApiOperation(value = "Returns the matching Departments with given unique key values.")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Departments getByDepartmentNameAndDepartmentHeadAndDepartmentDescription(@RequestParam("departmentName") String departmentName, @RequestParam("departmentHead") String departmentHead, @RequestParam("departmentDescription") String departmentDescription) {
        LOGGER.debug("Getting Departments with uniques key DepartmentNameAndDepartmentHeadAndDepartmentDescription");
        return departmentsService.getByDepartmentNameAndDepartmentHeadAndDepartmentDescription(departmentName, departmentHead, departmentDescription);
    }
    ...
    public Page<Doctors> findAssociatedDoctorses(@PathVariable("id") Integer id, Pageable pageable) {
        ...
        return departmentsService.findAssociatedDoctorses(id, pageable);
    }
