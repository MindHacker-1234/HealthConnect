...
import com.healthconnect_pro.health_connect.service.PatientsService;
...
public class PatientsController {
    ...
    @ApiOperation(value = "Partially updates the Patients instance associated with the given id.")
    @PatchMapping(value = "/{id:.+}")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Patients patchPatients(@PathVariable("id") Integer id, @RequestBody @MapTo(Patients.class) Map<String, Object> patientsPatch) {
        LOGGER.debug("Partially updating Patients with id: {}" , id);

        Patients patients = patientsService.partialUpdate(id, patientsPatch);
        LOGGER.debug("Patients details after partial update: {}" , patients);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Patients getByEmail(@PathVariable("email") String email) {
        LOGGER.debug("Getting Patients with uniques key Email");
        return patientsService.getByEmail(email);
    }
	...
	@ApiOperation(value = "Returns the total count of Patients instances matching the optional query (q) request param.")
    ...
    public Page<Appointments> findAssociatedAppointmentses(@PathVariable("id") Integer id, Pageable pageable) {
        ...
        return patientsService.findAssociatedAppointmentses(id, pageable);
    }
