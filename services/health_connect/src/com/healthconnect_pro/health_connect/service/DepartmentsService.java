...
public interface DepartmentsService {
     ...
     */
    Departments getById(Integer departmentsId);
     ...
     */
    List<Departments> findByMultipleIds(List<Integer> departmentsIds, boolean orderedReturn);

    /**
     * Find and return the Departments for given departmentName  anddepartmentHead  anddepartmentDescription  if exists.
     *
     * @param departmentName value of departmentName; value cannot be null.
     * @param departmentHead value of departmentHead; value cannot be null.
     * @param departmentDescription value of departmentDescription; value cannot be null.
     * @return Departments associated with the given inputs.
     * @throws EntityNotFoundException if no matching Departments found.
     */
    Departments getByDepartmentNameAndDepartmentHeadAndDepartmentDescription(String departmentName, String departmentHead, String departmentDescription);
     ...
     * @throws EntityNotFoundException if no Departments is found with given input.
     */
    Departments partialUpdate(Integer departmentsId, Map<String, Object> departmentsPatch);
     ...
     */
    Departments delete(Integer departmentsId);
    ...
    /*
     * Returns the associated doctorses for given Departments id.
     *
